...
<tileset version="1.10" tiledversion="1.12.2" name="hierba-alta-2" tilewidth="16" tileheight="16" tilecount="8" columns="8">
 <image source="../img/hierba-alta-2.png" width="128" height="16"/>
 <tile id="0">
  <animation>
